...
const profileReducer = (state = initialState, action) => {
  switch (action.type) {
    case ADD_BEER_TO_FAVOURITES_SUCCESS:
    case FETCH_BEER_LIST_FAVOURITES_SUCCESS:
    case REMOVE_BEER_FROM_FAVOURITES_SUCCESS:
      return {
        hasError: null,
        favourites: [...action.payload]
      };
    case ADD_BEER_TO_FAVOURITES_FAILURE:
    case FETCH_BEER_LIST_FAVOURITES_FAILURE:
    case REMOVE_BEER_FROM_FAVOURITES_FAILURE:
      return {
